    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(MResource.getIdByName(getApplication(), "id", "selectCountryCode")).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ResetPhonePwdActivity.this, SelectCountryCodeActivity.class);
                intent.putExtra(Constants.EXTRA_LOGIN_WAY, Constants.PHONE_PWD_RESET);
